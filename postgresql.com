...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2023-03-15T18:38:50.574333" />
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/pg_ivm-151-security-update-release-2603/">pg_ivm 1.5.1 Security update release</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2023-03-02 by IVM Development Group</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pgtt-v210-released-2602/">pgtt v2.10 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2023-02-24 by MigOps</li>
              </ul>
            </li>
 ...
 <div class="container margin">
   ...
   <div class="row">
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5HB"> How collation works</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5Hz"> Everything you know about setting `work_mem` is wrong.</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5HA"> Vincent Picavet</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5Hx"> TLS setup on Postgres 15 – Common Practice</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;cary huang</li>
              <li><i class="far fa-clock"></i>&nbsp;2023-03-10</li>
            </ul>
          </div>
        </div>
